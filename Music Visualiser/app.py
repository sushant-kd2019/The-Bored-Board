#made using Avi Rzayev's medium article https://medium.com/analytics-vidhya/how-to-create-a-music-visualizer-7fad401f5a69
...
filename = input("enter music file name")
